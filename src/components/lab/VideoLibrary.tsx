                      ...
                      <div className="space-y-2">
                        ...
                        {video.original_prompt && (
                          <div>
                            ...
                            <p className="text-sm leading-relaxed">{video.original_prompt}</p>
                          </div>
                        )}
                        
                        {video.enriched_prompt && video.enriched_prompt !== video.original_prompt && (
                          <div>
                            <p className="text-xs font-medium text-muted-foreground mb-1">Enriched Prompt</p>
