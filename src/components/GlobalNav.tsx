...
import { Zap, Network, Package, CalendarCheck, Settings, Sparkles, Target, DollarSign, Library, Layers } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Stories", path: "/stories-library", icon: Layers },
